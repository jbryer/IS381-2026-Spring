...
```{r, eval = FALSE}
#use R as a calculator (note you need to chage eval = TRUE once you assign the variables below)
alpha =
k =
K = (k*(k-1))/2
alpha.star = alpha/k
...
```{r, eval = FALSE}
#The pairwise.t.test() command uses a comma between the two variables x and y, 
# instead of a tilde like the aov() command.  pairwise.t.test(y, x, p.adj = "")
# NOTE: change eval = TRUE once you have this working
