---
title: "Null Hypothesis Testing and Bootstrapping"
subtitle: "IS381 - Statistics & Probability for Data Analytics"
...
```{r, echo=FALSE, fig.width=10,fig.height=5, fig.align='center'}
hist(samp2, main='Population Distribution', xlab="", freq=FALSE, 
     ylim=c(0, max(d$y, h$density)+.5), col='steelblue', border = "white", 
	 cex.main = 1.5, cex.axis = 1.5, cex.lab = 1.5)
```
